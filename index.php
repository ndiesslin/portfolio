    ...
    <body>
        ...
        <div id="bottom-nav">
            ...
            <ul>
                ...
                <li>
                    <a href="docs/documentation.pdf">site documentation</a>
                </li>
            </ul>
        </div>
